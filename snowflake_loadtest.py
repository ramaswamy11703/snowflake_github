...
def main():
    ...
    table_config = table_config_lineitem  # or table_config_orders
    ...
    if test_results:
        ...
        csv_file, graph_file = generate_reports(test_results, table_config, "Snowflake")
        
        print(f"\n🎉 Snowflake load test suite completed!")
